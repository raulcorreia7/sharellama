...
import { submissionUpdateSchema, type SubmissionUpdate } from "@locallama/shared";
            ...
            <>
              ...
              <form onSubmit={handleUpdate}>
                ...
                <button
                  type="submit"
                  disabled={submitting()}
                  class="mb-6 w-full rounded bg-blue-600 px-4 py-2 text-sm font-medium text-white hover:bg-blue-700 disabled:opacity-50"
                >
                ...
                <Show
                  ...
                  fallback={
                    <button
                      ...
                      class="rounded border border-red-300 px-4 py-2 text-sm font-medium text-red-600 hover:bg-red-50 dark:border-red-800 dark:text-red-400 dark:hover:bg-red-900/20"
                    >
                      Delete Submission
                    </button>
                  }
